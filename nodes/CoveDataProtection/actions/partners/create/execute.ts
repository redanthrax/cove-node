...
export async function execute(this: IExecuteFunctions, index: number): Promise<IDataObject> {
	...
	const level = this.getNodeParameter('level', index, 'EndCustomer') as string;
	const createDefaultAccount = this.getNodeParameter('createDefaultAccount', index, false) as boolean;
